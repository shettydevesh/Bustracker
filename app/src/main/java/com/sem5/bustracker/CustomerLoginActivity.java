        ...
        mRegistration.setOnClickListener(view -> {
            ...
            mAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(CustomerLoginActivity.this, task -> {
                if(!task.isSuccessful()){
                    ...
                    DatabaseReference email_db = FirebaseDatabase.getInstance().getReference().child("User").child("Customers").child(user_id).child("Email");
                    email_db.setValue(email);
                    DatabaseReference password_db = FirebaseDatabase.getInstance().getReference().child("User").child("Customers").child(user_id).child("Password");
